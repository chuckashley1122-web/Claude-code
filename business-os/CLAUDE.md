...
business is, who it sells to, and how it sounds. If `business.md` is still the
blank template, say so and ask the owner to fill it in — do not guess the
...
| 5 | `operations` | the owner's tasks and calendar | `data/5-operations.md` |
...
bottom of the file. The CEO agent surfaces those gaps to the owner.
