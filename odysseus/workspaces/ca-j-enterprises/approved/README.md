# Approved knowledge sources — ca-j-enterprises
...
General reference material — platform policies, sourcing protocols, standards —
lives in [`../reference/`](../reference/) instead, where it is tracked in Git and
can be reviewed and versioned. This directory is only for real business documents
